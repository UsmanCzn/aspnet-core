...
{
    public abstract class DukkatTekProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DukkatTekProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DukkatTekProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DukkatTekProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DukkatTekProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DukkatTekProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DukkatTekProjectDbContext, Task<T>> func)
        {
            T result;
